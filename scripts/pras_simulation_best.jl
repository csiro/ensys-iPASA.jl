#############################################################################
# PRAS simulation for the LT_BEST long-term scenario.
...
#
#   julia --project --threads auto scripts/pras_simulation_best.jl [SAMPLES]
#############################################################################
...
setup_logging(joinpath("log", "pras_simulation_best.log"))
@info "Starting the application.." scenario = "LT_BEST" samples

run_scenario("LT_BEST"; samples = samples,
