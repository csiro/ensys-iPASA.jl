#############################################################################
# PRAS simulation for the LT_WORST long-term scenario.
...
#
#   julia --project --threads auto scripts/pras_simulation_worst.jl [SAMPLES]
#############################################################################
...
setup_logging(joinpath("log", "pras_simulation_worst.log"))
@info "Starting the application.." scenario = "LT_WORST" samples

run_scenario("LT_WORST"; samples = samples,
